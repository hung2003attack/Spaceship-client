        ...
        >
            ...
            >
                <DivSearch color={colorText}>
                    ...
                    {search && <Input color={colorText} value={valueS} onChange={handleSearch} />}
                    <P
                        z="1.4rem"
                        css={`
                            text-align: center;
                ...
                <Div width="100%" display="block" css="height: 94%; padding 3px 8px; overflow-y: overlay;">
                    {data?.map((v) => {
                        ...
                        return name.includes(valueS.toLowerCase()) ? (
                            <Div width="100%" css="height: 45px; padding 3px 8px; margin-top: 3px;">
